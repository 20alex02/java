...
import cz.muni.fi.pb162.hw01.impl.displays.SegmentDisplay;
import cz.muni.fi.pb162.hw01.impl.displays.SegmentDisplayStringifier;
...
public final class Factory {
    ...
    public Display display(int size) {
        return new SegmentDisplay(size);
    }
    ...
    public DisplayStringifier stringifier() {
        return new SegmentDisplayStringifier();
    }
}
